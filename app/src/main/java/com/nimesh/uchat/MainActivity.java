...
import com.nimesh.uchat.adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity implements Search.OnDataPass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // check if the intent contains the tab number extra parameter
        if (getIntent().hasExtra("tab")) {
            int tabNumber = getIntent().getIntExtra("tab", 0);
...
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_heart));
        ...
        drawableResList.add(R.drawable.ic_notifications);
...
//                        tabLayout.getTabAt(0).setIcon(R.drawable.ic_home_fill);
                    ...
                    case 3:
                        tab.setIcon(R.drawable.ic_notifications_fill);
                        break;
